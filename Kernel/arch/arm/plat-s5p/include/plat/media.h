...
#define S3C_MDEV_MFC0        4
#define S3C_MDEV_MFC1        5
#define S3C_MDEV_JPEG       6
#define S3C_MDEV_PMEM       7
#define S3C_MDEV_PMEM_GPU1  8
#define S3C_MDEV_PMEM_ADSP  9
#define S3C_MDEV_TEXSTREAM  10
#define S3C_MDEV_FIMD       11
#define S3C_MDEV_G2D        12
#define S3C_MDEV_MAX        13
