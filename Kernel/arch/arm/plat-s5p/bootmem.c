...
static struct s3c_media_device media_devs[] = {/* SDKIM */
...
static unsigned int dmc1_paddr_start = 0x40000000;
static unsigned int dmc1_offset = 0x00000000;
...
#else
		SDKIM
		mdev->paddr = dmc1_paddr_start + dmc1_offset;
		dmc1_offset += mdev->memsize;
#endif
