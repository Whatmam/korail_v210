...
#include <linux/smsc911x.h>		// KSSON20100813
...
static struct resource s5p_dm9000_resources[] = {
	[0] = {
		.start = DIV_Y0_DM9000, // S5P_PA_DM9000
		.end   = DIV_Y0_DM9000, // S5P_PA_DM9000
		.flags = IORESOURCE_MEM,
	},
	[1] = {
// mkj change
#if defined(CONFIG_DM9000_16BIT)
		.start = DIV_Y0_DM9000 + 8, // S5P_PA_DM9000 + 8,
		.end   = DIV_Y0_DM9000 + 8, // S5P_PA_DM9000 + 8,
		.flags = IORESOURCE_MEM,
#else
		.start = DIV_Y0_DM9000 + 1,
		.end   = DIV_Y0_DM9000 + 1,
		.flags = IORESOURCE_MEM,
#endif
	},
...
#if 1	// KSSON20100813(START)
static struct smsc911x_platform_config s5p_smsc911x_platdata = {
...
struct platform_device s5p_device_smsc911x = {
    ...
    .resource   = s5p_dm9000_resources,
    .dev        = {
        .platform_data = &s5p_smsc911x_platdata,
    }
};
