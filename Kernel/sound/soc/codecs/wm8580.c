...
static int wm8580_register(struct wm8580_priv *wm8580)
{
    ...
    wm8580_write(codec, WM8580_DAC_CONTROL1, (0 << 4 )|(1 << 2)|(2 << 0));
...
int wm8580_set_outpath(u8 path)
{
    struct snd_soc_codec *codec = &wm8580->codec;

    printk("[wm8580_set_outpath] path(%d)\n", path);
    switch(path){
        case WM8580_SPK:		// linu out 3
        	gpio_request(S5PV210_GPH1(0), "GPH1_0");
			gpio_direction_output(S5PV210_GPH1(0), 1);
			gpio_free(S5PV210_GPH1(0));
            ...
            wm8580_write(codec, WM8580_DAC_CONTROL1, (0 << 4 )|(1 << 2)|(2 << 0));
            break;
        case WM8580_HDP :		// linu out 2
            wm8580_write(codec, WM8580_DAC_CONTROL1, (2 << 4 )|(0 << 2)|(1 << 0));
            break;
		case WM8580_NONE:		// line out 1
        	wm8580_write(codec, WM8580_DAC_CONTROL1, (1 << 4 )|(2 << 2)|(0 << 0));
            break;
        default :
            wm8580_write(codec, WM8580_DAC_CONTROL1, (2 << 4 )|(2 << 2)|(2 << 0));
            break;
    }
    return 0;
}
