...
static char banner[] __initdata =
	KERN_INFO "S5PC1XX LCD & TVOUT Driver, (c) 2009 Samsung Electronics\n";
extern int mv_backlight_onoff(struct platform_device *pdev, int onoff);
int __init s5p_tv_init(void)
{
	int ret;
#ifdef CONFIG_MV_BDII
	mv_backlight_onoff(NULL, 1);
#endif
	printk(banner);
