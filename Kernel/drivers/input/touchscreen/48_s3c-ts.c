...
#define        X_COOR_MIN      -25 
#define        X_COOR_MAX      3950 
#define        X_COOR_FUZZ     32
#define        Y_COOR_MIN      180
#define        Y_COOR_MAX      3830 
...
//----------- sv210 new touch ---------------------
			...
			x = (x_rev) ? (X_COOR_MAX - tem_x) : (tem_x - X_COOR_MIN);
			y = (y_rev) ? (Y_COOR_MAX - tem_y) : (tem_y - Y_COOR_MIN);
//----------- sv210 new touch ---------------------
#endif
