...
//#define CONFIG_TSRLOADER	1

//#define KORAIL_BASE					1 	// 2014.05.07 jay solidtec korail bootloader define
#define KORAIL_RAMDISK			1 	// 2014.08.31 jay solidtec korail bootloader define
...
#if KORAIL_BASE //2014.05.07 JAY for korial dm9000 cs change CS5 + 74LCX138
#define KORAIL_74LCX138_BASE	(0xA8000000)	
#define CONFIG_DM9000_BASE		(KORAIL_74LCX138_BASE + 8000)
#else
// nCS5
...
#define USBD_DOWN_ADDR		0xc4000000
...
//2014.05.07 JAY for korial boot shell name change
#if KORAIL_BASE
#define CFG_PROMPT              "SOLIDTEK # "   /* Monitor Command Prompt       */
#elif KORAIL_RAMDISK
#define CFG_PROMPT				"SOLIDTEC(RD) # "
#else
#define CFG_PROMPT              "V210 # "   /* Monitor Command Prompt       */
#endif
...
#define DMC0_MEMCONFIG_1	0x00C00323	// MemConfig1
...
#define DMC1_MEMCONFIG_0	0x40201323	// MemConfig0	512MB config, 8 banks,Mapping Method[12:15]0:linear, 1:linterleaved, 2:Mixed
#define DMC1_MEMCONFIG_1	0x00201323	// MemConfig1
...
#define DMC1_MEMCONFIG_1	0x00F01323	// MemConfig1
...
#define CONFIG_IDENT_STRING	" for SolidtekV210CM"
...
#define CONFIG_MTDPARTITION	"80000 380000 1FC00000"
...
#define CFG_LCD_FBUFFER				(0x20008000)

#define CONFIG_BOOTDELAY	1
#if defined(CFG_FASTBOOT_NANDBSP)
#if defined(KORAIL_RAMDISK)
//#define CONFIG_BOOTCOMMAND  "nand read C0008000 80000 300000; nand read 30A00000 380000 3C00000; bootm C0008000 30A00000" // MAX 60 MByte Ramdisk
#define CONFIG_BOOTCOMMAND  "nand read C0008000 80000 300000; nand read 30A00000 380000 A00000; bootm C0008000 30A00000" // MAX 60 MByte Ramdisk
#else
