...
#define DMC1_TIMING_DATA	0x13130005
...
#define MTDIDS_DEFAULT		"onenand0=s5pc110-onenand"	/* temporary */
#define MTDPARTS_DEFAULT	"mtdparts=s5pc110-onenand:1m(bootloader),5m(recovery),5m(kernel),3m(ramdisk),-(ubidata)"                     /* temporary */ 
#define CONFIG_BOOTARGS    	"console=ttySAC2,115200 ubi.mtd=4 " MTDPARTS_DEFAULT
